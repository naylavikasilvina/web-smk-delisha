...
<div class="container" style="margin-top: 30px;">
    <div class="panel panel-success">
        <div class="panel-heading"><h3 class="panel-title">🎓Tambah Jurusan</h3></div>
        <div class="panel-body">
            <form method="POST" enctype="multipart/form-data" class="form-horizontal">

                <!-- Nama Jurusan -->
                <div class="form-group">
                    <label class="col-sm-2 text-left">Nama Jurusan</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-6">
                        ...
                        <a href="jurusan.php" class="btn btn-default">◀️Kembali</a>
                    </div>
                </div>
            </form>
            ...
            <?php
                if (isset($_POST["submit"])) {
                    ...
                    if (!in_array($formatfile, $allowedtype)) {
                        ...
                        $cek = $pdo->prepare("SELECT id FROM jurusan WHERE nama = ?");
                        $cek->execute([$nama]);
                        if ($cek->rowCount() > 0) {
                            echo '<div class="alert alert-danger"><strong>Maaf!</strong> Nama jurusan sudah digunakan.</div>';
                        } else {
                            $simpan = $pdo->prepare("
                                INSERT INTO jurusan (nama, gambar, keterangan)
                                VALUES (?, ?, ?)
                            ");
                            $save = $simpan->execute([
                                $nama,
